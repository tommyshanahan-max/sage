 ...
 * sides against each other, which is exactly what the screen does. */
  ...
  "pay.due":           ["Due {when}", "{when} 付"],
  "pay.claimed":       ["{who} says they paid this, {when}", "{who} 说已付，{when}"],
  "pay.confirmed":     ["{who} confirmed it arrived, {when}", "{who} 确认已收到，{when}"],
  "pay.denied":        ["{who} says it has not arrived, {when}", "{who} 说还没收到，{when}"],
  "pay.paidChip":      ["Paid", "已付"],
  "pay.waitingChip":   ["Waiting", "待确认"],
  "pay.dueChip":       ["Due", "待付"],
  "pay.iPaid":         ["I paid this", "我已付款"],
  "pay.arrived":       ["It arrived", "已收到"],
  "pay.notYet":        ["Not arrived", "还没收到"],
  "pay.payVia":        ["Pay {who} at {where}", "通过 {where} 付给 {who}"],
  "pay.open":          ["Open their payment page", "打开对方的收款页面"],
  "pay.setLink":       ["Where you want to be paid", "你的收款方式"],
  "pay.linkHint":      ["Your own PayPal, Wise, Payoneer or bank page. Only you can change it.",
                        "你自己的 PayPal、Wise、Payoneer 或银行收款页。只有你能修改。"],
  "pay.linkSince":     ["Set {when}", "{when} 设置"],
  "pay.linkChanged":   ["These details were changed {when}. If that was not them, ask before you pay.",
                        "收款方式于 {when} 修改过。如非本人所改，付款前请先核实。"],
  "pay.noLink":        ["{who} has not said where to pay yet.", "{who} 还没填收款方式。"],
  "pay.save":          ["Save", "保存"],
  "pay.leaves":        ["Paying happens on their page, not here. This board never holds your money and is not told when you pay — you each say so below.",
                        "付款在对方的页面完成，不在这里。本平台不经手资金，也不会自动知道你是否付了款——需要你们各自确认。"],
  "pay.bothSaid":      ["Both of you have said so.", "双方都已确认。"],
  "pay.remind":        ["Remind them", "提醒对方"],
  "pay.reminded":      ["Reminded", "已提醒"],
  "pay.tooSoon":       ["Already reminded today", "今天已经提醒过了"],
  "pay.receipt":       ["Receipt", "收据"],
  "pay.rTitle":        ["Receipt", "收据"],
  "pay.rFor":          ["For", "款项"],
  "pay.rFrom":         ["Paid by", "付款方"],
  "pay.rTo":           ["Paid to", "收款方"],
  "pay.rAmount":       ["Amount", "金额"],
  "pay.rWhere":        ["Sent to", "付至"],
  "pay.rSaid":         ["What was said", "双方确认"],
  "pay.rNotTax":       ["A record of what the two of them said, kept by this board. Not a tax invoice, and this board is not a party to it.",
  ...
  "deal.failed":       ["That did not open. Try again.", "没打开，再试一次。"],
  "deal.offline":      ["No connection. Try again.", "连不上，再试一次。"],
  ...
  "sh.tReal":          ["Genuine, or ten times back", "正品保障 · 假一赔十"],
  "sh.tPay":           ["WeChat Pay or Alipay", "微信支付 · 支付宝"],
  "sh.tPost":          ["Posted from Melbourne", "墨尔本直发"],
  "sh.said":           ["From the shopkeeper", "店主的话"],
  ...
  "se.title":          ["Sell into China", "把产品卖到中国"],
  "se.mark":           ["Aozhoubaba · 澳洲爸爸", "澳洲爸爸 · Aozhoubaba"],
  "se.h1":             ["Sell into China without going there.",
                        "不用去中国，也能把货卖到中国。"],
  "se.sub":            ["You make it. I already have the buyers, and they already know how to pay.",
                        "你负责生产。买家我这边已经有了，他们也早就习惯这样付款。"],
  "se.nSent":          ["parcels delivered", "已送达包裹"],
  "se.nRev":           ["buyer reviews", "买家评价"],
  "se.nSince":         ["selling since", "开店时间"],
  "se.how":            ["How it works", "怎么合作"],
  "se.youDo":          ["You", "你"],
  "se.you1":           ["Send me the product.", "把产品寄给我。"],
  "se.iDo":            ["Me", "我"],
  "se.me1":            ["Photograph it and write it up in Chinese.", "拍照，写中文文案。"],
  "se.me2":            ["Put it in front of buyers who already follow me.", "推给已经关注我的买家。"],
  "se.me3":            ["Take the order and the money.", "接单，收款。"],
  "se.me4":            ["Pack it and post it from Melbourne.", "墨尔本打包直发。"],
  "se.me5":            ["Answer her when something goes wrong.", "出问题我来回复。"],
  "se.paid":           ["You are paid in Australian dollars, into an Australian bank.",
                        "你收到的是澳元，打进澳洲的银行账户。"],
  "se.paidSub":        ["No yuan to convert, no account in China, no waiting on a remittance.",
                        "不用换人民币，不用开中国账户，不用等汇款。"],
  "se.no1":            ["No Tmall store", "不用开天猫店"],
  "se.no2":            ["No Chinese entity", "不用注册中国公司"],
  "se.no3":            ["No agent in the middle", "中间不用找代理"],
  "se.cta":            ["Send me what you make \u2192", "把你的产品发给我 \u2192"],
  "se.mail":           ["tom@thexchange.app", "tom@thexchange.app"],
  "se.subject":        ["Selling into China", "把产品卖到中国"],
  "se.seeShop":        ["See the shop these buyers already use", "看看买家在用的那家店"],
  ...
  // ---- the wallet ----------------------------------------------------------
  /* WRITTEN FOR THE PAYEE, WHO MAY BE EITHER SIDE OF THE CORRIDOR.
     Every other block in this file is for somebody on the board. These are
     for somebody being paid, and the payee is as often in Shanghai as in
     Sydney — a tutor, an agent, an editor. wallet.html shipped with none of
     this: 22 screens, about 200 strings, English only, on the half of the
     product whose whole claim is that it was not written for an English
     reader.

     THE CHINESE IS NOT A RENDERING OF THE ENGLISH where the two readers do
     not need the same sentence. An English reader is told what a passkey is;
     a Chinese reader is told 人脸/指纹, which is what their phone calls it
     and what they already do ten times a day. The fee line names 微信支付 and
     支付宝 rather than "a wallet". And nothing here explains a Chinese
     payment instrument back to a Chinese reader — see the note in CLAUDE.md
     about the line under the QR code. */

  "wl.title":          ["Wallet", "钱包"],
  "wl.suffix":         ["The Exchange", "The Exchange"],
  "wl.loading":        ["Loading", "加载中"],

  /* home */
  "wl.send":           ["Send", "转账"],
  "wl.request":        ["Request", "收款"],
  "wl.add":            ["Add", "充值"],
  ...
  "wl.recent":         ["Recent", "最近"],
  "wl.seeAll":         ["See all", "全部"],
  "wl.nothingYet":     ["Nothing yet", "还没有记录"],
  "wl.nothingYetSub":  ["Payments you send and receive show here", "收付款都会出现在这里"],
  "wl.methods":        ["Payment methods", "付款方式"],
  "wl.nothingConn":    ["Nothing connected", "还没绑定"],
  "wl.help":           ["Help and safety", "帮助与安全"],
  "wl.helpSub":        ["Report a payment, spot a scam", "举报交易，识别骗局"],
  "wl.sentYou":        ["{who} sent you {amt}", "{who} 给你转了 {amt}"],
  "wl.acceptIn24":     ["Accept within 24 hours", "24 小时内确认收款"],
  "wl.requestedAmt":   ["{who} requested {amt}", "{who} 向你收款 {amt}"],

  /* activity rows */
  "wl.toWho":          ["To {who}", "转给 {who}"],
  "wl.fromWho":        ["From {who}", "来自 {who}"],
  "wl.youAsked":       ["You asked {who}", "你向 {who} 收款"],
  "wl.askedYou":       ["{who} asked you", "{who} 向你收款"],
  "wl.addedMoney":     ["Added money", "充值"],
  "wl.withdrawnBank":  ["Withdrawn to bank", "提现到银行卡"],

  /* setup */
  "wl.setUp":          ["Set up wallet", "开通钱包"],
  "wl.setUpHero":      ["Send and receive money with people you've met here", "和这里认识的人互相收付款"],
  "wl.setUpWaiting":   ["{who} sent you {amt}. Set up to accept it.", "{who} 给你转了 {amt}，开通后即可收款。"],
  "wl.whereYouLive":   ["Where you live", "所在地区"],
  "wl.walletIn":       ["Wallet in {cur}", "{cur} 钱包"],
  "wl.paidStraight":   ["{cur} · paid straight to your bank", "{cur} · 直接到账银行卡"],
  "wl.provHolds":      ["The provider holds and moves the money", "资金由持牌机构保管和划转"],
  "wl.provHoldsSub":   ["The Exchange never has your bank login or card number.", "The Exchange 不接触你的网银账号和卡号。"],
  "wl.noReverse":      ["Payments can't always be reversed", "付款不一定能撤回"],
  "wl.noReverseSub":   ["Once someone accepts your money, getting it back depends on them.", "对方确认收款后，能否退回取决于对方。"],
  "wl.knownOnly":      ["Only pay people you've dealt with", "只给打过交道的人付款"],
  "wl.knownOnlySub":   ["The Exchange will never ask you to send money to unlock anything.", "The Exchange 绝不会让你付钱来解锁任何东西。"],
  "wl.fees":           ["Fees", "手续费"],
  "wl.feesSub":        ["None from your wallet or bank. 2.9% from a card, 3.4% from PayPal. Currency exchange includes about 0.5%.",
                        "钱包和银行卡免费。银行卡 2.9%，PayPal 3.4%。换汇另含约 0.5%。"],
  "wl.acceptTerms":    ["I've read and accept the wallet terms.", "我已阅读并同意钱包服务条款。"],
  "wl.walletCreated":  ["Wallet created.", "钱包已开通。"],

  /* verify */
  "wl.confirmIt":      ["Confirm it's you", "实名认证"],
  "wl.confirmed":      ["Confirmed", "已认证"],
  "wl.youreVerified":  ["You're verified", "认证已通过"],
  "wl.canSendUpTo":    ["You can send up to {amt} a day.", "每天最多可转 {amt}。"],
  "wl.continue":       ["Continue", "继续"],
  "wl.checkUnfinished":["Your check didn't finish. You can start it again.", "上次认证没完成，可以重新开始。"],
  "wl.whyVerify":      ["Anyone who moves money has to check who they're dealing with. The provider does the check, on its own page.",
                        "持牌机构必须核实客户身份。认证在机构自己的页面完成。"],
  "wl.idPhoto":        ["A photo of your ID card or passport", "身份证或护照照片"],
  "wl.selfie":         ["A quick selfie to match it", "一段人脸验证"],
  "wl.onlyPassFail":   ["The Exchange only learns whether you passed.", "The Exchange 只知道认证是否通过。"],
  "wl.toProvider":     ["Continue to the provider", "前往认证"],
  "wl.doLater":        ["Do this later", "稍后再说"],

  /* security */
  "wl.keepSafe":       ["Keep it safe", "支付安全"],
  /* NOT "Face ID". A Chinese phone says 人脸 or 指纹 and the brand name means
     nothing on Android, which is most of this audience. */
  "wl.faceOn":         ["Turn on Face ID", "开启人脸/指纹支付"],
  "wl.faceWhy":        ["Every payment is confirmed on this phone with Face ID or its passcode, so nobody else can send your money even if they open your account.",
                        "每笔付款都要在这台手机上用人脸、指纹或锁屏密码确认，别人拿到账号也转不走钱。"],
  "wl.faceIsOn":       ["Face ID is on for payments.", "人脸/指纹支付已开启。"],
  "wl.noPasskeyTest":  ["This browser can't use Face ID. In test mode, payments use a test confirmation instead.",
                        "这个浏览器不支持人脸/指纹。测试模式下改用测试确认。"],
  "wl.noPasskey":      ["This browser can't use Face ID. Open the Exchange in Safari or Chrome to pay.",
                        "这个浏览器不支持人脸/指纹，请用 Safari 或 Chrome 打开付款。"],
  "wl.skipTest":       ["Skip (test mode)", "跳过（测试模式）"],
  "wl.faceFailed":     ["Face ID wasn't set up. You can try again, or use test mode.", "没有开启成功，可以重试或使用测试模式。"],

  /* sources */
  "wl.howPay":         ["How you'll pay", "付款方式"],
  "wl.connectSomething":["Connect something to pay from. You finish on the provider's own page.",
                        "绑定一个付款方式，在机构自己的页面完成。"],
  "wl.connected":      ["Connected", "已绑定"],
  "wl.unionpay":       ["UnionPay card", "银联卡"],
  "wl.wechatPay":      ["WeChat Pay", "微信支付"],
  "wl.cardKind":       ["Debit or credit card", "储蓄卡或信用卡"],
  "wl.bankKind":       ["Bank account", "银行账户"],
  "wl.paypal":         ["PayPal", "PayPal"],
  "wl.feePct":         ["{p}% fee", "手续费 {p}%"],
  "wl.noFee":          ["No fee", "免手续费"],
  "wl.skipForNow":     ["Skip for now", "暂时跳过"],
...
/* THE DEALS COLUMN ON THE WALLET HOME. Labels on figures, so each one is as
  ...
  /* ready */
  "wl.allSet":         ["All set", "开通完成"],
  "wl.walletReady":    ["Your wallet is ready", "钱包已就绪"],
  "wl.identity":       ["Identity", "实名"],
  "wl.notYetNeeded":   ["Not yet — needed to send", "未实名 — 转账前需要"],
  "wl.faceLabel":      ["Face ID", "人脸/指纹"],
  "wl.on":             ["On", "已开启"],
  "wl.notSetUp":       ["Not set up", "未开启"],
  "wl.payFrom":        ["Pay from", "付款方式"],
  "wl.nothingYetShort":["Nothing yet", "还没有"],
  "wl.moneyReceive":   ["Money you receive", "收到的钱"],
  "wl.yourBank":       ["Your bank", "你的银行卡"],
  "wl.yourWallet":     ["Your wallet", "你的钱包"],
  "wl.openWallet":     ["Open wallet", "打开钱包"],

  /* send */
  "wl.sendTo":         ["Send to", "转给谁"],
  "wl.searchMembers":  ["Search members", "搜索成员"],
  "wl.whoPaying":      ["Who are you paying?", "付款给谁？"],
  "wl.noWalletShort":  ["hasn't set up a wallet", "还没开通钱包"],
  "wl.nobodyByName":   ["Nobody by that name", "没有这个人"],
  "wl.canPayMembers":  ["You can pay members of the Exchange", "只能付款给 The Exchange 的成员"],
  "wl.payWho":         ["Pay {who}", "付款给 {who}"],
  "wl.memberGone":     ["That member isn't here any more.", "这个成员已经不在了。"],
  "wl.theyHaveNoWallet":["{who} hasn't set up a wallet yet, so there's nowhere for the money to go. Ask them to set one up — it's under their Profile.",
                        "{who} 还没开通钱包，钱没有地方可去。让对方在个人主页里开通一下。"],
  "wl.back":           ["Back", "返回"],
  "wl.confirmBeforeSend":["Confirm your identity before you can send. ", "转账前需要先实名。"],
  "wl.whatFor":        ["What's it for?", "款项说明"],
  "wl.egRead":         ["e.g. Script read-through", "例如：剧本通读"],
  "wl.reasonCn":       ["Reason for the payment (required for China)", "付款事由（入境必填）"],
  "wl.egConsulting":   ["e.g. Consulting fee", "例如：咨询费"],
  "wl.reasonCnHint":   ["Payments into mainland China are checked, and need a stated reason.", "入境资金需审核，必须填写付款事由。"],
  "wl.walletBalance":  ["Wallet balance", "钱包余额"],
  "wl.balNoFee":       ["{amt} · no fee", "{amt} · 免手续费"],
  "wl.connectToPay":   ["Connect a card or bank to pay from. ", "先绑定一张卡或银行账户。"],
  "wl.connect":        ["Connect", "去绑定"],
  "wl.amountToSend":   ["Amount to send to {who}, in {cur}", "转给 {who} 的金额，{cur}"],

  /* review */
  "wl.checkAndSend":   ["Check and send", "确认付款"],
  "wl.toWhoNote":      ["to {who}", "给 {who}"],
  "wl.fee":            ["Fee", "手续费"],
  "wl.youPay":         ["You pay", "你支付"],
  "wl.theyReceive":    ["{who} receives", "{who} 收到"],
  "wl.rate":           ["Exchange rate", "汇率"],
  "wl.rateHeld":       ["Rate held for", "汇率锁定"],
  "wl.expired":        ["expired", "已过期"],
  "wl.arrives":        ["Arrives", "到账"],
  "wl.ifNotAccepted":  ["If not accepted", "未确认收款"],
  "wl.backIn24":       ["Back to you in 24 hours", "24 小时后原路退回"],
  "wl.overBalance":    ["That's more than your balance. Go back and pay from a card or bank.", "超过钱包余额，请返回改用银行卡付款。"],
  "wl.overLimit":      ["That's over your daily sending limit.", "超过每日转账限额。"],
  "wl.firstTime":      ["You haven't paid {who} before. Only send money to someone you've actually dealt with. Once they accept, it can't be reversed.",
                        "你还没给 {who} 付过款。只给真正打过交道的人转账，对方确认后无法撤回。"],
  "wl.reasonGiven":    ["Reason given: {why}", "付款事由：{why}"],
  "wl.sendAmtTo":      ["Send {amt} to {who}", "向 {who} 支付 {amt}"],
  "wl.bankMustApprove":["Your bank needs to approve this.", "需要你的银行确认。"],
  "wl.sentAmtTo":      ["Sent {amt} to {who}.", "已向 {who} 支付 {amt}。"],

  /* request */
  "wl.requestFrom":    ["Request from", "向谁收款"],
  "wl.requestFromWho": ["Request from {who}", "向 {who} 收款"],
  "wl.theySeeOneTap":  ["They'll see what you're asking for, and can pay it in one tap.", "对方会看到收款说明，一键即可付款。"],
  "wl.egCoverage":     ["e.g. Script coverage", "例如：剧本审读"],
  "wl.sendRequest":    ["Send request", "发起收款"],
  "wl.requestSent":    ["Request sent.", "收款请求已发出。"],
  "wl.requestCantTake":["A request can't take money on its own. It only shows what you're asking for.", "收款请求不会自动扣款，只是告诉对方你要收多少。"],
  "wl.amountToRequest":["Amount to request, in {cur}", "收款金额，{cur}"],
  "wl.member":         ["member", "成员"],

  /* activity */
  "wl.activity":       ["Activity", "交易记录"],
  "wl.show":           ["Show", "筛选"],
  "wl.all":            ["All", "全部"],
  "wl.in":             ["In", "收入"],
  "wl.out":            ["Out", "支出"],
  "wl.nothingHereYet": ["Nothing here yet", "还没有记录"],
  "wl.request1":       ["Request", "收款请求"],
  "wl.withdrawal":     ["Withdrawal", "提现"],
  "wl.sentHas24":      ["Sent. {who} has 24 hours to accept.", "已发出，{who} 有 24 小时确认收款。"],
  "wl.done":           ["Done.", "完成。"],
  "wl.theyReceived":   ["They receive", "对方收到"],
  "wl.theySent":       ["They sent", "对方支付"],
  "wl.paidFrom":       ["Paid from", "付款方式"],
  "wl.paidTo":         ["Paid to", "收款到"],
  "wl.reason":         ["Reason", "付款事由"],
  "wl.reference":      ["Reference", "交易号"],
  "wl.from":           ["From", "来自"],
  "wl.to":             ["To", "到"],
  "wl.acceptAmt":      ["Accept {amt}", "确认收款 {amt}"],
  "wl.accepted":       ["Accepted.", "已确认收款。"],
  "wl.declineSendBack":["Decline and send it back", "拒收并退回"],
  "wl.declinedBack":   ["Declined. The money went back.", "已拒收，款项已退回。"],
  "wl.cancelPayment":  ["Cancel payment", "取消付款"],
  "wl.cancelledBack":  ["Cancelled. The money is back with you.", "已取消，款项已退回。"],
  "wl.payAmt":         ["Pay {amt}", "支付 {amt}"],
  "wl.decline":        ["Decline", "拒绝"],
  "wl.requestDeclined":["Request declined.", "已拒绝收款请求。"],
  "wl.cancelRequest":  ["Cancel request", "取消收款请求"],
  "wl.requestCancelled":["Request cancelled.", "收款请求已取消。"],
  "wl.reportProblem":  ["Report a problem", "举报问题"],

  /* report */
  "wl.rNotMine":       ["I didn't make this payment", "这笔付款不是我发起的"],
  "wl.rUnlock":        ["I was asked to pay to unlock something", "对方让我付钱来解锁什么"],
  "wl.rNotDelivered":  ["I paid but didn't get what was agreed", "我付了款但没收到约定的东西"],
  "wl.rOther":         ["Something else", "其他"],
  "wl.whatHappened":   ["What happened?", "发生了什么？"],
  "wl.anythingElse":   ["Anything else we should know (optional)", "还有什么要补充的（选填）"],
  "wl.scamWarn":       ["If you think it's a scam, don't send any more money, and don't move the conversation to another app.",
                        "如果怀疑是骗局，不要再付款，也不要转到别的软件上聊。"],
  "wl.sendReport":     ["Send report", "提交举报"],
  "wl.reportSent":     ["Report sent.", "举报已提交。"],
  "wl.reported":       ["Reported", "已举报"],
  "wl.gotIt":          ["Thanks, we've got it", "已收到"],
  "wl.replyOneDay":    ["Someone from the Exchange will reply in Messages within one working day.", "The Exchange 会在一个工作日内通过消息回复你。"],
  "wl.backToWallet":   ["Back to wallet", "返回钱包"],

  /* add and withdraw */
  "wl.addMoney":       ["Add money", "充值"],
  "wl.connectToAdd":   ["Connect a card or bank to add money from.", "先绑定一张卡或银行账户。"],
  "wl.enterAmount":    ["Enter an amount", "请输入金额"],
  "wl.addAmt":         ["Add {amt}", "充值 {amt}"],
  "wl.moneyAdded":     ["Money added.", "充值完成。"],
  "wl.amountToAdd":    ["Amount to add, in {cur}", "充值金额，{cur}"],
  "wl.addBankFirst":   ["Add the bank account to withdraw to.", "先绑定提现的银行卡。"],
  "wl.addBankAccount": ["Add bank account", "绑定银行卡"],
  "wl.moreThanBalance":["That's more than your balance.", "超过钱包余额。"],
  "wl.withdrawAmtTo":  ["Withdraw {amt} to {label}", "提现 {amt} 到 {label}"],
  "wl.withdrawStarted":["Withdrawal started.", "提现已发起。"],
  "wl.available":      ["Available {amt}", "可提现 {amt}"],
  "wl.amountToWithdraw":["Amount to withdraw, in {cur}", "提现金额，{cur}"],
  "wl.toLabel":        ["To {label}", "到 {label}"],
  "wl.noFeeNextDay":   ["No fee · usually the next working day", "免手续费 · 一般次个工作日到账"],

  /* methods and settings */
  "wl.feeWhenPay":     ["Fee when you pay", "付款手续费"],
  "wl.default":        ["Default", "默认"],
  "wl.yes":            ["Yes", "是"],
  "wl.no":             ["No", "否"],
  "wl.makeDefault":    ["Make default", "设为默认"],
  "wl.defaultChanged": ["Default changed.", "默认方式已更改。"],
  "wl.remove":         ["Remove", "解绑"],
  "wl.removeWhat":     ["Remove {label}?", "解绑 {label}？"],
  "wl.canConnectAgain":["You can connect it again later.", "以后还可以再绑定。"],
  "wl.removed":        ["Removed.", "已解绑。"],
  "wl.connectCardEtc": ["Connect a card, bank or PayPal", "绑定银行卡、账户或 PayPal"],
  "wl.onProviderPage": ["On the provider's own page", "在机构自己的页面完成"],
  "wl.keepsRefOnly":   ["The Exchange keeps a reference to each account and its last four digits. Never a login, password or full card number.",
                        "The Exchange 只保存每个账户的标识和后四位，绝不保存账号、密码或完整卡号。"],
  "wl.settings":       ["Wallet settings", "钱包设置"],
  "wl.faceForPay":     ["Face ID for payments", "支付时人脸/指纹验证"],
  "wl.onNDevices":     ["On · {n} device", "已开启 · {n} 台设备"],
  "wl.onNDevices2":    ["On · {n} devices", "已开启 · {n} 台设备"],
  "wl.notConfirmed":   ["Not confirmed", "未实名"],
  "wl.limits":         ["Limits", "限额"],
  "wl.limitsSub":      ["Send up to {day} a day · {today} sent today", "每日上限 {day} · 今日已转 {today}"],
  "wl.staysInWallet":  ["Stays in your wallet", "留在钱包里"],
  "wl.nConnected":     ["{n} connected", "已绑定 {n} 个"],
  "wl.closeWallet":    ["Close wallet", "注销钱包"],
  "wl.withdrawFirst":  ["Withdraw your balance first", "请先提现余额"],
  "wl.sendPerDay":     ["Send per day", "每日转账上限"],
  "wl.afterConfirm":   ["After confirming identity", "实名后开放"],
  "wl.sentLast24":     ["Sent in the last 24 hours", "近 24 小时已转"],
  "wl.receivePerMonth":["Receive per month", "每月收款上限"],
  "wl.testLimits":     ["Test limits. The real ones depend on the provider and its licence.", "测试限额。实际限额取决于持牌机构。"],
  "wl.neverAsk":       ["The Exchange will never ask you to send money ", "The Exchange 绝不会让你付钱"],
  "wl.neverAskRest":   ["to unlock an introduction, a seat, or a feature. Anyone who does is not us.", "来解锁引荐、名额或任何功能。这样做的人不是我们。"],
  "wl.reportPayment":  ["Report a payment", "举报一笔交易"],
  "wl.reportPaymentSub":["Open it from Activity, then Report a problem", "在交易记录里打开，选“举报问题”"],
  "wl.moveApp":        ["Someone asked to move to another app to pay", "有人让你换个软件付款"],
  "wl.moveAppSub":     ["That's the most common start of a scam", "这是骗局最常见的开头"],
  "wl.wrongPerson":    ["Sent to the wrong person", "转错人了"],
  "wl.wrongPersonSub": ["If they haven't accepted, cancel it from the payment", "对方还没确认的话，可以在这笔交易里取消"],
  "wl.closeWhat":      ["Closing removes your payment methods and stops payments to and from you. Your payment history is kept, as the law requires.",
                        "注销会解绑所有付款方式并停止收付款。交易记录按法规要求保留。"],
  "wl.stillHave":      ["You still have {amt}. Withdraw it first.", "钱包里还有 {amt}，请先提现。"],
  "wl.withdrawBalance":["Withdraw balance", "提现余额"],
  "wl.walletClosed":   ["Wallet closed.", "钱包已注销。"],
  "wl.cancel":         ["Cancel", "取消"],

  /* confirmation and errors */
  "wl.confirmTest":    ["Confirm (test mode)", "确认（测试模式）"],
  "wl.confirmFace":    ["Confirm with Face ID", "人脸/指纹确认"],
  "wl.confirming":     ["Confirming…", "确认中…"],
  "wl.confirmingSay":  ["Confirming.", "确认中。"],
  "wl.notConfirmedSay":["Not confirmed.", "未确认。"],
  "wl.setFaceFirst":   ["Set up Face ID for the wallet first.", "请先开启钱包的人脸/指纹验证。"],
  ...
  /* the steps of a payment, as the timeline says them */
  "wl.st.sent":        ["Sent", "已发出"],
  "wl.st.charged":     ["Paid", "已扣款"],
  "wl.st.accepted":    ["Accepted", "已确认收款"],
  "wl.st.in_review":   ["Being checked", "审核中"],
  "wl.st.paying_out":  ["On its way to the bank", "正在打款到银行卡"],
  "wl.st.completed":   ["Done", "已完成"],
  "wl.st.declined":    ["Declined — money returned", "已拒收 — 款项退回"],
  "wl.st.cancelled":   ["Cancelled — money returned", "已取消 — 款项退回"],
  "wl.st.returned":    ["Not accepted in 24 hours — money returned", "24 小时未确认 — 款项退回"],
  "wl.st.failed":      ["Payment didn't go through", "付款未成功"],
  "wl.st.payout_failed":["The bank payment failed — we'll be in touch", "打款失败 — 我们会联系你"],
  "wl.st.started":     ["Started", "已发起"],

  /* and the one-word state on a row */
  "wl.stat.charging":  ["Waiting for the bank's approval", "等待银行确认"],
  "wl.stat.waiting":   ["Waiting to be accepted", "等待对方确认"],
  "wl.stat.paying_out":["On its way", "打款中"],
  "wl.stat.processing":["On its way", "处理中"],
  "wl.stat.completed": ["Done", "已完成"],
  "wl.stat.declined":  ["Declined", "已拒收"],
  "wl.stat.cancelled": ["Cancelled", "已取消"],
  "wl.stat.returned":  ["Returned", "已退回"],
  "wl.stat.failed":    ["Failed", "失败"],
  "wl.stat.payout_failed":["Needs attention", "需要处理"],
  "wl.stat.open":      ["Open", "待处理"],
  "wl.stat.paid":      ["Paid", "已支付"],

  /* the demo */
  "wl.tryingAs":       ["You're trying it as {who} · {role}. ", "你正在以 {who}（{role}）体验。"],
  "wl.switchPerson":   ["Switch person", "切换身份"],
  "wl.tryItAs":        ["Try it as", "选择身份"],
  "wl.demoFour":       ["Four invented people, each with their own wallet. Send money as one, then switch and accept it as the other.",
                        "四个虚构的人，各有各的钱包。用一个身份转账，再切换成另一个确认收款。"],
  "wl.nowYouAre":      ["You're now {who}.", "你现在是 {who}。"],
  "wl.demoReset":      ["Start the demo again", "重新开始体验"],
  "wl.demoRestarted":  ["The demo has started again.", "体验已重新开始。"],
  "wl.devTest":        ["In development · test provider: no real money moves and nothing is really connected.",
                        "开发中 · 测试通道：不会有真实资金流动，也没有真正绑定任何账户。"],
  /* WHERE SOMEBODY LIVES, IN THEIR OWN LANGUAGE. The names arrive from the
     server (lib/wallet/money.js) in English, because that file is the rules
     and has no reader. Translated at the point of drawing rather than there:
     one list of countries in English on the setup screen is exactly the tell
     that the Chinese was added afterwards, and it is the first screen a
     payee in Shanghai ever sees. Unknown ids fall back to what the server
     said, so a region added later shows up in English rather than as a key. */
  "wl.rg.FI":          ["Finland", "芬兰"],
  "wl.rg.AU":          ["Australia", "澳大利亚"],
  "wl.rg.CN":          ["Mainland China", "中国大陆"],
  "wl.rg.HK":          ["Hong Kong", "中国香港"],
  "wl.rg.US":          ["United States", "美国"],
  "wl.rg.OTHER":       ["Somewhere else", "其他地区"],
  "wl.pYou":           ["You", "你"],
  "wl.pYouSub":        ["Starts with no wallet — try setting one up", "还没有钱包 — 可以试着开通一个"],
  "wl.pMikko":         ["Mikko in Helsinki", "赫尔辛基的 Mikko"],
  "wl.pMikkoSub":      ["Pays in euros by card. His bank asks him to approve card payments.", "用银行卡付欧元。他的银行会要求他确认每笔卡支付。"],
  "wl.pMia":           ["Mia in Sydney", "悉尼的 Mia"],
  "wl.pMiaSub":        ["Has Australian dollars, and has asked Mikko for A$80", "有澳元余额，已向 Mikko 收款 A$80"],
  "wl.pWei":           ["Wei in Shanghai", "上海的 Wei"],
  "wl.pWeiSub":        ["Paid straight to his bank in yuan, after a check", "审核后人民币直接到账他的银行卡"],
  "wl.devDemo":        ["In development · a working demo on test money. No real money moves and nothing is really connected.",
                        "开发中 · 使用测试资金的可用演示。不会有真实资金流动，也没有真正绑定任何账户。"],
};
